...
const SavingsTrends = ({ savingsData = [] }) => {
    ...
    return [
      {
        ...
        data: months.map((month) => {
          const dataItem = savingsData.find(item => item.month === month);
  ...
  return (
    <ResponsiveLine
      ...
      enableGridY={false}
      pointSize={10}
      pointColor={theme.palette.savings.main}
      pointBorderWidth={2}
      pointBorderColor={theme.palette.savings.main}
      ...
      legends={[
        {
          ...
          symbolSize: 12,
          symbolShape: "circle",
          symbolBorderColor: theme.palette.savings.main,
          effects: [
            {
              on: "hover",
              style: {
